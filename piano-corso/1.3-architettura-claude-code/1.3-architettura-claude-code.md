...
**Testo da leggere**:
"Ora che abbiamo capito il paradigma agentico e la supervisione graduata, vediamo quali strumenti Claude Code mette a disposizione. Ma prima, vi presento il progetto su cui lavoreremo in tutte le demo del corso."

---

## SLIDE 2: Il Progetto del Corso
...
**Testo da leggere**:
"In tutte le demo del corso useremo un caso pratico reale: un backend API per la gestione ordini basato sul database Northwind. È un'API legacy con clienti, ordini e prodotti. Il codice è volutamente 'problematico' - rappresenta quello che spesso ereditiamo nei progetti reali."

---

## SLIDE 3: Lo Stato Attuale (Il Problema)
...
┌─────────────────────────────────────────┐
│  // TODO: Rifattorizzare (nota 2019)   │
│  // FIXME: problemi performance (2020)  │
│  // Funziona, non toccare!              │
│                                         │
│  • SQL injection nel filtro search      │
│  • Bug: country filtra per City         │
...
**Testo da leggere**:
"Ecco cosa ci troviamo di fronte: un file unico di 771 righe con commenti che promettono refactoring dal 2019. Ci sono bug di sicurezza come SQL injection, bug logici come un filtro country che cerca nella città, problemi di performance con query N+1. Nessun test, nessuna struttura. Codice reale, problemi reali."

---

## SLIDE 4: L'Obiettivo (La Soluzione)
...
**Testo da leggere**:
"L'obiettivo del refactoring è un'architettura 3-tier pulita. API layer per gestire HTTP e validazione. Service layer per la logica di business. Repository layer per l'accesso ai dati con query parametrizzate sicure. E test a ogni livello. Questo è il percorso che faremo insieme, usando Claude Code."

---

## SLIDE 5: L'Ecosistema Claude Code
