...
"Quali sono i trade-off tra Repository pattern
 e Active Record?"
...
**Testo da leggere**:
"Il PO non chiede a Claude di implementare. Chiede di esplorare. Quali pattern esistono? Quali sono i trade-off? Come procedere in modo incrementale? Quali rischi ci sono? Claude diventa un consulente che presenta opzioni."

---

## DEMO 2: Esplorazione Trade-off
...
**Testo da leggere durante la demo**:
"Chiediamo a Claude di presentare le opzioni per il layer di persistenza. Nota come presenta trade-off, non solo la soluzione. Poi possiamo approfondire chiedendo il perché della raccomandazione."
