...
│                  │  Fase 3: unit test     │
├──────────────────┼────────────────────────┤
│  Refactoring     │  Fase 1: separazione   │
│  Agent           │  Fase 2: migrazione    │
├──────────────────┼────────────────────────┤
...
**Testo da leggere**:
"Nel nostro corso useremo diversi subagenti. Test Agent per creare test. Refactoring Agent per la separazione dei layer. Documentation Agent per JSDoc e OpenAPI. Code Review Agent per verificare qualità e sicurezza dopo ogni fase."
