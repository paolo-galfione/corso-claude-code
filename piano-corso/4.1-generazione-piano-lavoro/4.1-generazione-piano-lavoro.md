...
3. Mostrare il piano generato da Claude:
   ...
   - Fase 1: Bug fix (sicurezza, logica, performance)
   - Fase 2: Separazione tier
   - Fase 3: ORM
   - etc.
...
1. Prendere una fase del piano generato (es. Fase 2: Separazione tier)
2. Chiedere dettaglio:

```
Dettaglia la Fase 2 "Separazione 3-tier".
...
**Testo da leggere durante la demo**:
"Approfondiamo la Fase 2. Claude dettaglia l'ordine di lavoro: partire da Customers perché è la più semplice, poi Orders, poi Details. Per ognuna specifica file da creare, metodi da spostare, test da aggiungere."
